...
package id.solodroid.validationlibrary;
...
import id.solodroid.validationlibrary.annotation.Checked;
import id.solodroid.validationlibrary.annotation.ConfirmPassword;
import id.solodroid.validationlibrary.annotation.Email;
import id.solodroid.validationlibrary.annotation.IpAddress;
import id.solodroid.validationlibrary.annotation.NumberRule;
import id.solodroid.validationlibrary.annotation.Password;
import id.solodroid.validationlibrary.annotation.Regex;
import id.solodroid.validationlibrary.annotation.Required;
import id.solodroid.validationlibrary.annotation.Select;
...
class AnnotationRuleFactory {
    // Debug
    static final String ANNOTATION_TAG = "AnnotationRuleConvert";
    ...
    private static Rule<Spinner> getSelectRule(Field field, View view, Select select) {
        if (!Spinner.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_SPINNER, field.getName(),
    ...
    private static Rule<TextView> getRequiredRule(Field field, View view, Required required) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), Required.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<View> getTextRule(Field field, View view, TextRule textRule) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), TextRule.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<TextView> getRegexRule(Field field, View view, Regex regexRule) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), Regex.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<View> getNumberRule(Field field, View view, NumberRule numberRule) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), NumberRule.class.getSimpleName()));
            return null;
    ...
    private static Rule<TextView> getPasswordRule(Field field, View view, Password password) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), Password.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<TextView> getConfirmPasswordRule(Field field, View view,
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(),
    ...
    private static Rule<View> getIpAddressRule(Field field, View view, IpAddress ipAddress) {
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_TEXT, field.getName(), IpAddress.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<Checkable> getCheckedRule(
        ...
        if (!Checkable.class.isAssignableFrom(view.getClass())) {
            Log.w(ANNOTATION_TAG, String.format(WARN_CHECKABLE, field.getName(),
